...
char auth[] = "bnQPG8feOFJnubHKylp2gn5w76qkXuB0";//authentication code from Blynk app
...
BLYNK_READ(V6) //Blynk app has something on V0
{
  
  Blynk.virtualWrite(V6, data[9]); //sending to Blynk
}

BLYNK_READ(V0) //Blynk app has something on V0
{
  
  Blynk.virtualWrite(V0, data[0]); //sending to Blynk
}
BLYNK_READ(V1) //Blynk app has something on V1
{
  
  Blynk.virtualWrite(V1, data[1]); //sending to Blynk
}
BLYNK_READ(V2) //Blynk app has something on V2
{
  
  Blynk.virtualWrite(V2, data[2]); //sending to Blynk
}
BLYNK_READ(V3) //Blynk app has something on V3
{
  
  Blynk.virtualWrite(V3, data[3]); //sending to Blynk
}
BLYNK_READ(V4) //Blynk app has something on V3
{
  
  Blynk.virtualWrite(V4, data[4]); //sending to Blynk
}
BLYNK_READ(V5) //Blynk app has something on V3
{
  
  Blynk.virtualWrite(V5, data[5]); //sending to Blynk
}
